...
if(  isset( $_GET["tarifkategorie"]  )){
	//Aus der URL
	$tarifkategorie=(int)$_GET["tarifkategorie"];//kommmt als umgewandelte Integer
...
<?php
$sql="SELECT * FROM tarife WHERE tarifKategorie=$tarifkategorie ORDER BY $feld $sortierung";
